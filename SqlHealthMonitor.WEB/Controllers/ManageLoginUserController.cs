...
{
    [Authorize]
    public class ManageLoginUserController : SqlHealthMonitor.Infrastructure.ControllerBase
    {
     
        public ManageLoginUserController()
        {
        }
        ...
        public ActionResult ForgetBrowser()
        {
            ...
            return RedirectToAction("Index", "ManageLoginUser");
        }
        ...
        public ActionResult RemoveLogin()
        {
            ...
            return View("RemoveLogin", "_Layout",linkedAccounts);
        }
